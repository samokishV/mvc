<div class="cover">
    <div class="inner-cover">
        <form method="post" action="" class="contacts-form needs-validation" novalidate>
            <h5 class="text-uppercase bold">Contact us</h5>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control" type="text" value="" id="subject" name="subject" required>
                </div>
            </div>
            <div class="form-group row">
            ...
            <input type="submit" class="btn btn-success btn-lg w-100" value="Send">
        </form>
    </div>
</div>
